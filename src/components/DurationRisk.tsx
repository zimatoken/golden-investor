  ...
  return (
    <div className="duration-risk">
      ...
      <p className="duration-risk-intro">
        ...
        примерно на её дюрацию. Формула хорошо работает для небольших изменений
        доходности. При больших движениях фактическое изменение может отличаться
        из-за convexity (выпуклости ценовой кривой). Это работает в обе стороны.
      </p>
      ...
      <div className="duration-risk-meaning">
        ...
        ОФЗ потеряют <em>примерно</em> 8% цены. Если ставка упадёт — наоборот,
        вырастут. Для более крупных движений фактическое изменение будет
        нелинейным. Поэтому длинные ОФЗ — это <em>ставка на снижение ставки</em>,
        а не «просто высокая доходность».
      </div>
